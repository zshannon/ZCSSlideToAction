#
#  Be sure to run `pod spec lint ZCSSlideToAction.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ZCSSlideToAction"
  s.version      = "0.0.1"
  s.summary      = "A drop-in UIView with Slide to Unlock like functionality."
  ...
  s.homepage     = "https://github.com/zshannon/ZCSSlideToAction"
  ...
  s.source       = { :git => "https://github.com/zshannon/ZCSSlideToAction.git", :tag => "0.0.1" }
